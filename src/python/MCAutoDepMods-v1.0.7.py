...
class Main():
    ...
    def __init__(self, root):
        ...
        self.selected_lang = tk.StringVar(value=self.current_lang)
        ...
        self.theme_menu = tk.Menu(master=self.setting_menu, tearoff=False)
    ...
    def build_menu(self):
        ...
        for theme in self.themes.keys():
            self.theme_menu.add_radiobutton(label=self.tr("MCAutoDepMods.window.main.menu.config.theme." + theme), value=theme, variable=self.selected_theme, command=self.apply_colors)
        
        self.setting_menu.add_cascade(label=self.tr("MCAutoDepMods.window.main.menu.config.language"), menu=self.lang_menu)
        self.setting_menu.add_cascade(label=self.tr("MCAutoDepMods.window.main.menu.config.theme"), menu=self.theme_menu)
    ...
    def set_translation_key(self):
        ...
        self.translations = {
            ...
            "ja-JP": {
                ...
                "MCAutoDepMods.window.main.menu.config.theme": "テーマ設定",
                "MCAutoDepMods.window.main.menu.config.theme.light": "ライトモード",
                "MCAutoDepMods.window.main.menu.config.theme.dark": "ダークモード",
            ...
            "en-US": {
                ...
                "MCAutoDepMods.window.main.menu.config.theme": "Theme Setting",
                "MCAutoDepMods.window.main.menu.config.theme.light": "Light Mode",
                "MCAutoDepMods.window.main.menu.config.theme.dark": "Dark Mode",
    ...
    def tr(self, key="", **kwargs):
        return self.translations[self.current_lang].get(key, "").format(**kwargs) or self.translations[self.default_lang].get(key, "").format(**kwargs) or self.current_lang + ": " + key
    ...
    def apply_colors(self):
        ...
        self.root.tk_setPalette(
            background=self.themes[self.current_theme]["background"],
            foreground=self.themes[self.current_theme]["foreground"],
            activeBackground=self.themes[self.current_theme]["activeBackground"],
            highlightbackground = self.themes[self.current_theme]["highlightbackground"],
            highlightcolor=self.themes[self.current_theme]["highlightcolor"],
            troughcolor=self.themes[self.current_theme]["troughcolor"],
            bordercolor=self.themes[self.current_theme]["bordercolor"],
            darkcolor=self.themes[self.current_theme]["darkcolor"]
        )
    ...
    def refresh_text(self):
        ...
        mods_fp = self.result_data["mods_fp"]
