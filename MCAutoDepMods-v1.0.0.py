            ...
            with jar.open("fabric.mod.json") as f:
                ...
                if not provides is None:
                    for i in provides:
                        mod_id.append(i)
                return "fabric", {
                    "mod": {"id":mod_id, "ver":data["version"]},
                    "path": jar_path,
                    "depends": depends
                    }
...
mods_select_button = tk.Button(master=root, text="modsディレクトリを選択", command=open_mods_dir)



mods_select_button.pack()
